...
export const protobufPackage = "twirote.planet.blog";
...
export class MsgClientImpl {
    ...
    CreateTimedoutPost(request) {
        ...
        const promise = this.rpc.request("twirote.planet.blog.Msg", "CreateTimedoutPost", data);
    ...
    UpdateTimedoutPost(request) {
        ...
        const promise = this.rpc.request("twirote.planet.blog.Msg", "UpdateTimedoutPost", data);
    ...
    DeleteTimedoutPost(request) {
        ...
        const promise = this.rpc.request("twirote.planet.blog.Msg", "DeleteTimedoutPost", data);
    ...
    CreateSentPost(request) {
        ...
        const promise = this.rpc.request("twirote.planet.blog.Msg", "CreateSentPost", data);
    ...
    UpdateSentPost(request) {
        ...
        const promise = this.rpc.request("twirote.planet.blog.Msg", "UpdateSentPost", data);
