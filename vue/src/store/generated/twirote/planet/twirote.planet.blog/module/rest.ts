...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryPostAll
   * @request GET:/twirote/planet/blog/post
   */
  queryPostAll = (
    query?: {
   ...
   * @request GET:/twirote/planet/blog/sentPost
   */
  querySentPostAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryAllSentPostResponse, RpcStatus>({
      path: `/twirote/planet/blog/sentPost`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/twirote/planet/blog/timedoutPost
   */
  queryTimedoutPostAll = (
    ...
    this.request<BlogQueryAllTimedoutPostResponse, RpcStatus>({
      path: `/twirote/planet/blog/timedoutPost`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
